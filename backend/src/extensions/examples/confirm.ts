...
export class ConfirmExtension implements Extension {
  ...
  get spec(): ExtensionSpec {
    return {
      name: 'confirm',
      title: this.i18n.t('texts.extensions.confirm.title'),
      ...
      description: this.i18n.t('texts.extensions.confirm.description'),
      type: 'tool',
      arguments: {},
    };
  }
...
class InternalTool extends NamedStructuredTool {
  ...
  protected async _call(arg: z.infer<typeof this.schema>): Promise<string> {
    ...
    return `Give the following result to the user. Do not modify it: ${result}."`;
  }
}
