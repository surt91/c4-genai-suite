...
| `reis.embeddings.bedrock.existingAccessKeySecret`             | Name of the Kubernetes Secret containing the Bedrock Secret Access Key. The key must be `bedrockSecretAccessKey`.       | `""`                                      |
